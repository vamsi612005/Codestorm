...
import { LayoutDashboard, Calendar, Settings, Bell, BookOpen, GraduationCap } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex">
            ...
            <div className="w-64 border-r border-grid-line bg-secondary/30 p-6 flex flex-col hidden lg:flex">
                ...
                <nav className="space-y-2 flex-1">
                    {[
                        ...
                        { icon: BookOpen, label: "My Courses", path: "/student-app/my-courses", active: true },
            ...
            <div className="flex-1 overflow-auto">
                ...
                <div className="p-8">
                    <div className="mb-8">
                        <h2 className="text-3xl font-black mb-2">All Subjects</h2>
