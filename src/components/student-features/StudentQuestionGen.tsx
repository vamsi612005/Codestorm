...
export const StudentQuestionGen = () => {
                ...
                {!isGenerated ? (
                    <div className="p-6 space-y-6">
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-gradient-to-r from-primary to-blue-500 rounded-xl text-black font-bold mt-2 hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95"
                        >
                            Generate Paper
                        </button>
                    </div>
                    ...
                    <div className="p-6 bg-white/5 h-full min-h-[380px] flex flex-col relative">
                        <div className="absolute top-4 right-4 text-primary flex items-center gap-1 text-xs font-medium bg-primary/10 px-2 py-1 rounded">
