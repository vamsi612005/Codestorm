                ...
                <div className="flex-1 p-4 space-y-6 overflow-y-auto">
                    ...
                    <div className="flex gap-3">
                        <div className="p-3 rounded-2xl rounded-tl-none bg-white/5 text-gray-200 text-sm max-w-[90%]">
                            Based on the document, <span className="text-accent font-semibold">Superposition</span> is a fundamental principle where a quantum system can exist in multiple states at the same time until it is measured.
                            <br /><br />
